...
# ROS libraries
from roboy_communication_cognition.srv import EvalSeq2Seq, TrainSeq2Seq, GenerateAnswer
import rospy
...
class GNLP():
    ...
    def train_server(self):
        s = rospy.Service('roboy/gnlp_train', TrainSeq2Seq, self.train)
    ...
    def eval_server(self):
        s = rospy.Service('roboy/gnlp_eval', EvalSeq2Seq, self.evaluate)
